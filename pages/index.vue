<template>
  <div class="container-fuild">
    ...
    <div class="text-center">
      <h1 class="text-center mt-5 mb-5">Ujikompetensi Keahlian</h1>
    </div>
    <div class="container bg-secondary">
      <div class="row p-5">
        ...
        <div class="col-lg-4">
          <div class="card" style="width: 15rem">
            <img src="/assets/img/tbsm.png" class="card-img-top" alt="..." />
            <div class="card-body">
              <h5 class="card-title">TBSM (Teknik Dan Bisnis Sepeda Motor)</h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 pt-5">
          <div class="card" style="width: 15rem">
            <img src="/assets/img/toi.png" class="card-img-top" alt="..." />
            <div class="card-body">
              <h5 class="card-title">TOI(Teknik Otomasi Industri)</h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 pt-5">
          <div class="card" style="width: 15rem">
            <img src="/assets/img/dkv.png" class="card-img-top" alt="..." />
            <div class="card-body">
    ...
    <div class="container">
      <div class="judul">
        <h1 class="text-center mt-5 mb-5">STATISIK</h1>
      </div>
      <div class="row">
        <div class="col-6 P-5">
          <div class="card m-5 p-5 bg-secondary light">
            <div class="row">
              <div class="col"><h3 class="text-white">GURU</h3></div>
              <div class="col"><h3 class="text-white">80</h3></div>
            </div>
          </div>
        </div>
        <div class="col-6 P-5">
          <div class="card m-5 p-5 bg-secondary">
            <div class="row">
              <div class="col"><h3 class="text-white">SISWA</h3></div>
              <div class="col"><h3 class="text-white">1500</h3></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <h1 class="text-center mt-5 mb-5">Berita</h1>
      <div class="row mb-5">
