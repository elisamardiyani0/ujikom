<template>
  <div class="container">
    <h2 class="text-center mb-4">Ekstrakulikuler</h2>
    <div class="row">
      <!--Ekstrakulikuler-->
      <div class="col-lg-6">
